...
var app = new Vue({
  ...
  data: {
    ...
    question: {
      introduction: '5月24日，大法官釋字第748號解釋出爐，世界各地媒體陸續發出新聞，宣布「同性婚姻合法化，台灣將是亞洲第一」。有趣的是，或許是各界對台灣的國際地位了解不一，也可能是中國的「善意提醒」，各家媒體對台灣的稱呼並不一致。\n\n如果你是責任編輯，下面這題，你會怎麼選？',
    ...
    sections: {
      ...
      world: {
        title: '從世界看台灣意識、媒體識讀',
        description: '我們把這次釋憲相關的國際新聞鋪在世界地圖上，可以看出有些區域的覆蓋很密集，有些區域則完全沒有新聞覆蓋。在這張圖上，除了可以看見世界如何面對台灣的國家定位，還可以看見「有哪些國家的媒體看得見台灣」以及「哪些媒體選擇報導台灣、LGBTQ人權這樣少數中的少數議題」，也能反思在資料蒐集的過程中，「我們台灣人比較容易接觸到哪些媒體」。一張圖，許多問題，值得細細思考。'
      }
    },
    conclusion: {
      title: '結論：#醒醒吧你沒有國家',
